# CCLP
This repository is the Pytorch code for our paper published in **Knowledge-Based Systems** "_**Cross-sensor contrastive learning-based pre-training for machinery fault diagnosis under sample-limited conditions**_".
